			...
			<%
				...
				for r = 0 to ubound(rsdados,2)
					...
					%>
						...
						<tr class='d-none visivel' data-opt = "" data-nome="<%= lcase(nome) %>" data-mesano="<%= mes_ano_vencimento %>"  data-menu="#metas_<%= ID_Cliente %>" data-slider="top" data-grupo="clientes" data-close="true" data-close-cor="mq-cor-branca" style="display: table-row;">
							<td><%= nome %></td>
